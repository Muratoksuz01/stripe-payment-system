...
const Cart = () => {
  ...
  switch (ali) {
    case 1:
      // burada paymentelement cagırıp form direk geliyor 
      content = <CheckoutPage products={cartProduct} />;
      break;
    case 3:
      //burada tum card number ,date,cvv numarasını kendimiz alıyoruz 
      content = <CheckoutForm1 />;
      break;
    case 10:
      //burada kişiyi sepete ekledigi urunlerle stripte kendi odeme sayfasına yonlendiriyoruz 
      content = (<Container>
